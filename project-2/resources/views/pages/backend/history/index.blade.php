...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">History Index</h4>
                            ...
                            <tr>
                                ...
                                <td class="action-cell">
                                    <div class="action-buttons">
                                        <a type="button" href="history/edit" class="btn btn-primary">
                ...
                <div class="create-btn-wrapper">
                    <a href="history/create" class="btn btn-success">
                        + Create
                    </a>
                </div>
            </div>
